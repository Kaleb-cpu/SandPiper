    ...
    render() {
        return (
            ...
            <div class="container-fluid bg15">
                <div class="row " >
                <div class="col-10 left font-a21 w3-animate-right">DIRECTOR: ASSET RATIONALIZATION</div>
                    <div class="col-3 text-right font-a11 w3-animate-right">
                        <div>Teresa Hargreaves,</div>
                        <div>P. Land, P.S.L.,</div>
                        <div>Certified PMP and PMI-ACP</div>
                        </div>{/*title*/}
                ...
                <hr/>
                <div class="row " >
                <div class="col-10 left font-a21 w3-animate-right">DIRECTOR: LAND</div>
                <div class="col-3 text-right font-a11 w3-animate-left ">
                    <div>Anne Hand, </div>
                    <div>P.Land, Certified PMP</div>
                    </div>{/*title*/}
                    <div class="col-6 text-left font-a33 fade-in-image " >
                ...
                <hr/>
                <div class="row " >
                <div class="col-10 left font-a21 w3-animate-right">DIRECTOR: FINANCE and BUSINESS DEVELOPMENT</div>
                    <div class="col-3 text-right font-a11 w3-animate-right">
                        <div>Leif Prebeau-Menezes,</div>
